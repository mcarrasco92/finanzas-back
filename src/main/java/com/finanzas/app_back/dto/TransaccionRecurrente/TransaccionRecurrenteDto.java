...
public class TransaccionRecurrenteDto {
    ...
    public String validaCampos() {
        ...
        if ((catEgresoId == null || catEgresoId.isEmpty()) && "Egreso".equals(tipo)) return "Debe proporcionar catEgresoId para transacciones de tipo Egreso.";
        if ((catIngresoId == null || catIngresoId.isEmpty()) && "Ingreso".equals(tipo)) return "Debe proporcionar catIngresoId para transacciones de tipo Ingreso.";
        ...
        if ((fecha == null || fecha.isEmpty()) && !"Semanal".equals(periodicidad)) return "El campo fecha es obligatorio.";
        if ((dia == null || dia.isEmpty()) && "Semanal".equals(periodicidad)) return "El campo día es obligatorio.";
        return "";
    }
}
